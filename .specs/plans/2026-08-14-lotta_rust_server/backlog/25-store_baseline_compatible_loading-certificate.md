...
- `crates/lotta-store/src/transcript/append.rs` (Task 24) writes the entries this loader reads; confirm `transcript::append` still passes with the loader in place : ☐ (PRESERVED / REGRESSION)
