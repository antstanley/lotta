...
- `crates/lotta-store/src/transcript/load.rs` (Task 25) must still accept every fixture `verify` flags; confirm `transcript::load::tolerances` still passes : ☐ (PRESERVED / REGRESSION)
