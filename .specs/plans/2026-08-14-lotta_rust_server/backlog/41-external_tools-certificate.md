...
- `crates/lotta-tools/src/registry.rs` (Task 32) holds the merged registry; confirm `registry::atomic_swap` still passes with external tools present : ☐ (PRESERVED / REGRESSION)
